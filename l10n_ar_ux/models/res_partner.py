...
class ResPartner(models.Model):
    ...
    def try_write_commercial(self, data):
        ...
        error_message = []
        vat = data.get("vat")
        l10n_latam_identification_type_id = data.get(
            "l10n_latam_identification_type_id"
        )
        l10n_ar_afip_responsibility_type_id = data.get(
        ...
        if vat and l10n_latam_identification_type_id:
            commercial_partner = (
                ...
                .sudo()
                .browse(int(data.get("commercial_partner_id")))
            )
            try:
                values = {
                    "vat": vat,
                    ...
                    "l10n_ar_afip_responsibility_type_id": int(
